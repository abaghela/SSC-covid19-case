...
plot_projection(
  ...
  theme_bw(base_size = 18) +
  labs(x = "Date", title = "No implementation of either intervention") +
...
plot_projection(
  ...
  theme_bw(base_size = 18) +
  labs(x = "Date", title = "Implementation of Nov. 7th restrictions only") +
  theme(plot.margin = unit(c(0.5, 0.9, 0.4, 0.4), "cm"))
...
plot_projection(
  ...
  theme_bw(base_size = 18) +
  labs(x = "Date", title = "Implementation of Nov. 19th restrictions only") +
  theme(plot.margin = unit(c(0.5, 0.9, 0.4, 0.4), "cm"))
...
plot_projection(
  ...
  theme_bw(base_size = 18) +
  labs(x = "Date", title = "Both Interventions One Week Earlier") +
  theme(plot.margin = unit(c(0.5, 0.9, 0.4, 0.4), "cm"))
...
list(
  ...
  bind_rows(., .id = "Model") %>% 
  ungroup() %>% 
  select(Model, reported_date, mu_0.5) %>% 
  mutate(mu_0.5 = round(mu_0.5)) %>% 
  pivot_wider(., names_from = reported_date, values_from = mu_0.5) %>% 
  knitr::kable()
```
